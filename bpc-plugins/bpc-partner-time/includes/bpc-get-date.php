<?php
     ...
     */
     if($book_time_type == 'Book Time Of Day')
     {
         ...
         */
         $day = strtolower(date('l', strtotime($datenow)));

         print "<Br> current day " . $day;
    ...
    <div class="home-time-box" >
        ...
        <div class="home-time-content">
            <div class="e3ve-home-time">
                 ...
                 if($morning == 'yes')
                 {
                     print "<input type='button' value='Morning' class='btn btn-success' />";
                 }
                 if($afternoon == 'yes')
                 {
                     print "<input type='button' value='Afternoon' class='btn btn-success' />";
                 }
                 if($evening == 'yes')
                 {
                     print "<input type='button' value='Evening' class='btn btn-success' />";
                 }
                ?>
            </div>
        </div>
